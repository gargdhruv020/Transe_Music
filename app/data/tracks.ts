...
const listRemix = [
  { title: "Lutt Le Gaya x Voices In My Head x Aria (Edit)", artist: "AFTERLYF / FLIPSYD", film: "Bollytech Flips", isRemix: true },
  { title: "Zara Zara x Voices In My Head / Age of Love (Mix)", artist: "Dark Techno", film: "Bollytech Flips", isRemix: true },
  ...
  { title: "Besharam Rang (Afro / Peak-Time Techno Edit)", artist: "Mwaki", film: "Bollytech Flips", isRemix: true },
  { title: "Tu Tu Hai Wahi (Acid Techno Edit)", artist: "How Deep Is Your Love", film: "Bollytech Flips", isRemix: true },
  { title: "Ghungroo x Piece of Your Heart (Peak-Time Mashup)", artist: "Meduza", film: "Bollytech Flips", isRemix: true },
  { title: "Raabta x Breathe (Melodic Techno Mashup)", artist: "CamelPhat", film: "Bollytech Flips", isRemix: true },
  { title: "Ghar Aaja Pardesi x Innerbloom (Dil Se Rave Edit)", artist: "RÜFÜS DU SOL", film: "Bollytech Flips", isRemix: true },
  { title: "Main Hoon Don x Simulation (Techno Mashup)", artist: "Little Noise", film: "Bollytech Flips", isRemix: true },
  { title: "Ae Dil Hai Mushkil x Spaceman (Techno Edit)", artist: "Hardwell", film: "Bollytech Flips", isRemix: true },
  { title: "Satrangi Re (Dil Se) x Matan Caspi - Agadir (Edit)", artist: "DJ NYK", film: "Bollytech Flips", isRemix: true },
  { title: "Akhiyaan Gulaab x Safari / Melodic Techno (Remix)", artist: "DJ NYK", film: "Bollytech Flips", isRemix: true },
  ...
  { title: "Deewani Mastani x Consciousness (DEBB Melodic Techno)", artist: "Anyma", film: "Bollytech Flips", isRemix: true },
  { title: "Dum Maro Dum x Progressive Techno Stabs (Remix)", artist: "Dj Ujjwal", film: "Bollytech Flips", isRemix: true },
  { title: "Chaar Bottle Vodka x Stephanie", artist: "Peak-Time Edit", film: "Bollytech Flips", isRemix: true },
  { title: "Nadaan Parinde x Astral (Melodic Techno Edit)", artist: "Tale of Us", film: "Bollytech Flips", isRemix: true },
  { title: "Tujhe Bhula Diya (Techno Mashup)", artist: "Beat Of The Drum", film: "Bollytech Flips", isRemix: true },
  ...
  { title: "Zara Zara (RHTDM) (Psytrance Remix)", artist: "Dee & Matz", film: "Psytrance & Festival", isRemix: true },
  { title: "Silsila Yeh Chahat Ka (Psy Edit)", artist: "TrapAsur / ZOINT", film: "Psytrance & Festival", isRemix: true },
  { title: "Choli Ke Peeche x Great Spirit (Goa Club Mashup)", artist: "Vini Vici", film: "Psytrance & Festival", isRemix: true },
  { title: "Manali Trance (Forest Flip)", artist: "Heavy Psycore", film: "Psytrance & Festival", isRemix: true },
  { title: "Hai Rama Ye Kya Hua (Psy Edit)", artist: "Beats By Nakai", film: "Psytrance & Festival", isRemix: true },
  { title: "Bolo Har Har Har (Shiva)", artist: "High-BPM Psy Remix", film: "Psytrance & Festival", isRemix: true },
  { title: "Aankh Marey x Deep Jungle Walk (Psy Mashup)", artist: "Astrix", film: "Psytrance & Festival", isRemix: true },
  { title: "Tip Tip Barsa Paani (Club Edit)", artist: "Offbeat Psy Bass", film: "Psytrance & Festival", isRemix: true },
  { title: "Dua (Shanghai) (Dark Trance Mix)", artist: "DJ Lemon", film: "Psytrance & Festival", isRemix: true },
  { title: "Ganesha / Shiva Tandava Stotram x Psytrance Drops", artist: "Shanti People Style", film: "Psytrance & Festival", isRemix: true },
  { title: "Beedi Jalaile x Free Tibet (Goa Rave Bootleg)", artist: "Vini Vici", film: "Psytrance & Festival", isRemix: true },
  { title: "Dhoom Machale x Narco (Hardstyle/Psy Edit)", artist: "Timmy Trumpet", film: "Psytrance & Festival", isRemix: true },
  ...
  { title: "Chaiyya Chaiyya x Chakra (Psy Festival Bootleg)", artist: "Vini Vici", film: "Psytrance & Festival", isRemix: true },
  ...
  { title: "Elevated (Shubh) x ACID / Bigroom Techno", artist: "Maddix", film: "Punjabi x Techno", isRemix: true },
  { title: "Cheques (Shubh) x Be The One (Hard Techno Edit)", artist: "Eli Brown", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Brown Munde (AP Dhillon) (Festival Bootleg)", artist: "Hardwell & Maddix", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Tauba Tauba (Bootleg)", artist: "Techno Stabs", film: "Punjabi x Techno", isRemix: true },
  { title: "Dope Shope (Techno Edit)", artist: "Body Move", film: "Punjabi x Techno", isRemix: true },
  { title: "White Brown Black (Festival Techno Mashup)", artist: "Light It Up", film: "Punjabi x Techno", isRemix: true },
  { title: "Obsessed (Riar Saab) (Techno Remix)", artist: "Adam Port", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Jogi (Panjabi MC) (Peak-Time Techno Edit)", artist: "Mike Prado", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Gabhru (Karan Aujla) (Bootleg)", artist: "Techno Driver", film: "Punjabi x Techno", isRemix: true },
  { title: "With You (Afterhours Melodic Edit)", artist: "AP Dhillon", film: "Punjabi x Techno", isRemix: true },
  { title: "Laung Gawacha (Techno / Afro House Edit)", artist: "H33T", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Players (Badshah & Karan Aujla) x Today (Bigroom Techno)", artist: "Maddix", film: "Punjabi x Techno", isRemix: true },
  ...
  { title: "Chura Liya Hai Tumne x Spaceman (Festival Drop)", artist: "Hardwell", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Tujhe Dekha Toh Yeh Jaana Sanam x Opus (Progressive Edit)", artist: "Eric Prydz", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Kaho Naa Pyaar Hai x Where You Are (Club Bootleg)", artist: "John Summit", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Tum Hi Ho x Adagio for Strings (Euphoric Trance Edit)", artist: "Tiësto", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Ya Ali (Gangster) x Tiger Lili (Sufi Melodic Techno)", artist: "Alar", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Akhiyaan Nu Rehn De x Seventh Day (Sufi Techno)", artist: "Max & Dana", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Karz Theme (2024 Reboot)", artist: "Melodic Driving Bass", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Aao Huzur x Hot Tub Time Machine (Deep Techno Mashup)", artist: "AVIRA", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Tere Bina (A.R. Rahman) (Melodic House/Techno)", artist: "Cloudcage", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Sajni Re x Euphoria Techno Stabs (Mashup)", artist: "DJ NYK", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Fanaa (A.R. Rahman) x Sixth Ocean Remix", artist: "Deeper Purpose", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Pardesiya (Param Sundari) (Melodic Techno Edit)", artist: "Manee", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Mere Khwabon Mein Jo Aaye x Fire Fire", artist: "Kasango", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Kaho Na Kaho (Murder) (Edit)", artist: "Arabic Melodic Techno", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Aaj Ki Raat (Stree 2) x Hard Techno Stabs (Remix)", artist: "DJ NYK", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Aayi Nai (Stree 2) (Edit)", artist: "Peak-Time Bounce", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Saat Samundar Paar x Techno Edit", artist: "Masai / Drumcode", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Kay Sera Sera (Techno Mashup)", artist: "Meet Her At The Love Parade", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Sexy Lady (Edit)", artist: "Sweet Nothing / Hardwell", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Shararat (Peak-Time Bollytech)", artist: "Caramelle", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Slowly Slowly (Techno Edit)", artist: "Jungle / Acid", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Sadqay (Melodic Techno Bootleg)", artist: "Desires", film: "Nostalgic Re-Flips", isRemix: true },
  { title: "Lucky Boy (Dark Techno Flip)", artist: "Portrait", film: "Nostalgic Re-Flips", isRemix: true },
  ...
  { title: "Aadat (Atif Aslam) x Sgadi Li Mi (Peak-Time Edit)", artist: "Charlotte de Witte", film: "Afterhours Bollytech", isRemix: true },
  { title: "Mere Rashke Qamar x Mercury (Techno Mashup)", artist: "Hi-LO & Space 92", film: "Afterhours Bollytech", isRemix: true },
  { title: "Mitwa x Akkan (Bollytech Flip)", artist: "Vikas J", film: "Afterhours Bollytech", isRemix: true },
  { title: "Karvaan x Out Of My Body (Techno Edit)", artist: "Little Noise", film: "Afterhours Bollytech", isRemix: true },
  ...
  { title: "Char Baj Gaye (Peak-Time Bollytech)", artist: "Feel The Vibe", film: "Afterhours Bollytech", isRemix: true },
  ...
  { title: "Jiya Jale (Deep Techno Mashup)", artist: "Killing Me", film: "Afterhours Bollytech", isRemix: true },
  ...
  { title: "Pardesi (Peak-Time Melodic Flip)", artist: "Anchor Point", film: "Afterhours Bollytech", isRemix: true },
  { title: "Ek Pal Ka Jeena x Horizon (Techno Bootleg)", artist: "ARTBAT", film: "Afterhours Bollytech", isRemix: true },
  ...
  { title: "Tere Liye (Prince) (Melodic Techno Flip)", artist: "Snow Flakes", film: "Afterhours Bollytech", isRemix: true },
  ...
  { title: "Heera Raanja (Bollytech Flip)", artist: "Let The Music Play", film: "Afterhours Bollytech", isRemix: true },
  { title: "Doobey (Gehraiyaan) x Explore Your Future (Melodic Techno)", artist: "Anyma", film: "Afterhours Bollytech", isRemix: true },
  { title: "Choli Ke Peeche (Psy-Bolly Flip)", artist: "Mr Jammer", film: "Psytrance & Forest", isRemix: true },
